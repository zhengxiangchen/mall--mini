...
Page({
  ...
  onLoad: function (options) {
    ...
    var orderId = options.uuid;

    wx.request({
      url: app.globalData.url + "/order/getByUuid",
      data: {
        uuid: orderId
      },
      method: 'GET',
      ...
      success: function (res) {
        ...
        that.setData({
          ...
          createTime: util.formatTime(new Date(order.createTime))
        })
  ...
  updateOrderStatus:function(){
    ...
    wx.request({
      url: app.globalData.url + "/order/updateOrderStatus",
      data: {
        uuid: orderId
      },
      method: 'GET',
